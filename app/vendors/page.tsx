...
const VENDOR_CATEGORIES: {
  ...
  },
  {
    ...
    vendors: [
      ...
      {
        name: "Expat Homes",
        tagline: "Furnished short-term rentals from 1 week. No local language required.",
        rating: 4.6,
        reviews: 218,
        priceRange: "€100–300",
        location: "EU-wide",
    ...
    vendors: [
      {
        ...
        tagline: "Sworn translations accepted by EU and government authorities. 48-hour turnaround.",
        rating: 4.9,
        reviews: 682,
        priceRange: "€40–180",
        location: "Remote",
      ...
      {
        name: "LingoLocal",
        tagline: "1-on-1 local language coaching for expats, from beginner to B1.",
        rating: 4.8,
        reviews: 319,
        priceRange: "€30–60/hr",
